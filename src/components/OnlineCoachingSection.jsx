      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center bg-gradient-to-br from-green-500 via-blue-600 to-purple-600 rounded-xl p-8 md:p-10 text-white mx-4 md:mx-0 shadow-2xl">
          ...
          <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
            ...
            <span className="px-3 py-1 rounded-full text-sm md:text-base font-medium text-white">1 Minute</span>
              <span className="text-2xl md:text-3xl font-bold">$20</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
              <span className="px-3 py-1 rounded-full text-sm md:text-base font-medium text-white">5 Minutes</span>
              <span className="text-2xl md:text-3xl font-bold">$40</span>
            </div>
            <div className="flex items-center justify-center space-x-3">
            <span className="px-3 py-1 rounded-full text-sm md:text-base font-medium text-white">Full Game</span>
